...
Es decir, que $b_0 + b_1$ representa la puntuación media de los chicos cuya madre ha terminado secundaria, `r sum(coef(m))`. Por tanto, $\beta_1$ representa la diferencia entre las puntuaciones medias.
