...
Es decir, que $\beta_0$ representa la puntuación media de los chicos cuya madre no ha terminado secundaria, `r coef(m)[1]`
...
Es decir, que $\beta_0 + \beta_1$ representa la puntuación media de los chicos cuya madre ha terminado secundaria, `r sum(coef(m))`. Por tanto, $\beta_1$ representa la diferencia entre las puntuaciones medias.
...
Razonando igual que antes tenemos que $\beta_0$ representa la puntuación media de los chicos cuya madre ha terminado secundaria, `r coef(m)[1]`. Como vemos el valor coincide con lo obtenido antes.
...
- si secundaria_si = 0: $kid\_score = \beta_0 + \beta_1 mom\_iq + e$
- si secundaria_si = 1: $kid\_score = (\beta_0 + \beta_2) + \beta_1 mom\_iq + e$
