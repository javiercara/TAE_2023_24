...
$$
R_a^2 = 1 - \frac{\hat s_R^2}{\hat s_y^2} = 1 - \frac{(n-k-1) SSM}{(n-1) SST}
$$
...
Se tiene que $R_{a1}^2 = 0.2103$, $R_{a2}^2 = 0.2095$. Por tanto el primer modelo es preferible al segundo.
