...
\begin{equation}
y_i = \beta_1 x_{1i} + \beta_2 x_{2i} + \beta_3 x_{3i} + e_i, \ i = 1,2,\cdots,n
\end{equation}
...
\begin{equation}
y = \beta_0 + \beta_1 x + \beta_2 x^2 + e \Rightarrow y = \beta_0 + \beta_1 x_1 + \beta_2 x_2
\end{equation}

- modelos con funciones en los regresores

\begin{equation}
y = \beta_0 + \beta_1 x + \beta_2 log x + e \Rightarrow y = \beta_0 + \beta_1 x_1 + \beta_2 x_2
\end{equation}
...
\begin{equation}
y_i = \beta_0 + \beta_1 x_{1i} + \beta_2 x_{1i}^2 + e_i
\end{equation}
...
\begin{equation}
\log(y_i) = \beta_0 + \beta_1 x_{1i} + \beta_2 e^{x_{2i}} + e_i
\end{equation}
...
\begin{equation}
kid\_score_i = \beta_0 + \beta_1 mom\_iq_i + \beta_2 z_i + e_i
\end{equation}
